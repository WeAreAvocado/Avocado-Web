    ...
    <main className="relative overflow-hidden">
      ...
      <div>
        <Image
          ...
          width={120}
          height={120}
          className="absolute scale-50 sm:scale-75 md:scale-100 top-[3.5rem] left-14 sm:top-24 sm:left-10 md:top-32 md:left-20 md:hover:scale-110 duration-150 ease-in transition-all"
        />
        ...
        <Image
          ...
          width={130}
          height={130}
          className="absolute scale-50 sm:scale-75 md:scale-100 top-[4rem] -right-2 sm:top-[10rem] sm:-right-4 md:top-[14rem] md:-right-4 md:hover:scale-110 duration-150 ease-in transition-all"
        />
        <Image
          ...
          width={150}
          height={150}
          className="absolute hidden sm:scale-75 md:scale-100 sm:top-[27rem] sm:left-[1rem] md:top-[40rem] md:left-[2rem] md:hover:scale-110 duration-150 ease-in transition-all"
        />
        <Image
          ...
          width={150}
          height={150}
          className="absolute scale-50 sm:scale-75 md:scale-100 top-[22rem] -right-[4.5rem] sm:top-[28rem] sm:right-[2rem] md:top-[38rem] md:right-[12rem] md:hover:scale-110 duration-150 ease-in transition-all"
        />
        <Image
          ...
          width={120}
          height={120}
          className="absolute scale-50 sm:scale-75 md:scale-100 top-[14rem] -right-[2.5rem] sm:top-[19rem] sm:right-[8rem] md:top-[24rem] md:right-[8rem] md:hover:scale-110 duration-150 ease-in transition-all"
        />
        <Image
          ...
          width={200}
          height={200}
          className="absolute scale-50 sm:scale-75 md:scale-100 top-[23rem] -left-[6rem] sm:top-[28rem] sm:left-[14rem] md:top-[32rem] md:left-[14rem] md:hover:scale-110 duration-150 ease-in transition-all"
        />
      </div>
